...
try:
    # 确保日志文件的父目录存在
    if not os.path.exists(os.path.dirname('../logs/AutomatedTest.log')):
        os.makedirs(os.path.dirname('../logs/AutomatedTest.log'))
except Exception as e:
    print(f"Failed to create log directory: {e}")


# 明确指定日志输出的文件路径和日志级别
logger = _get_logger('../logs/AutomatedTest.log', 'info')
